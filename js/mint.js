...
var t_address = "0x5e4797e84fcde24c1c7d02f7ef14e511f4d2c31e"
var t_abi = [
    {
        "inputs": [
            {
    ...
    web3.eth.getAccounts().then(async (tx) => {
        if (tx[0] !== undefined) {
            ...
            web3.eth.net.getId().then(async (netId) => {
                if (netId === chainId) {
                    $('#connect_btn').hide()
                    $('.address').html('Connected : ' + truncateString(String(user_address), 10));
                    $('#mint_btn').show();
